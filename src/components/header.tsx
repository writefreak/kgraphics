...
const Header = () => {
  return (
    <div className="hidden md:flex  fixed top-0 left-0 right-0 z-50 justify-center px-14 pt-7">
      <div className="flex bg-white shadow-md w-[800px] p-1 px-2 rounded-full items-center justify-between">
        ...
        <Button className="rounded-full bg-white text-[#030142] border-2 hover:bg-[#030142] hover:-translate-y-1 hover:text-white transition-all duration-500 border-[#030142]">
          Let's Connect
        </Button>
      </div>
    </div>
